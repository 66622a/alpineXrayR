...
# 下载 XrayR
wget https://github.com/XrayR-project/XrayR/releases/download/${LATEST_VERSION}/XrayR-linux-arm64-v8a.zip -O /tmp/XrayR-linux-arm64-v8a.zip

# 解压缩
unzip /tmp/XrayR-linux-arm64-v8a.zip -d /etc/XrayR
